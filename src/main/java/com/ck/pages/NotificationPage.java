...
public class NotificationPage  extends WrapperMethods {
	...
	@FindBy(how = How.XPATH, using = "//android.widget.ImageView[@content-desc=\"CashKaro\"]")
	...
	@FindBy(how = How.XPATH, using = "//*[@text='Ajio']")
	MobileElement ajioStore;
	@FindBy(how = How.XPATH, using = "//*[@text='NotificationTest']")
	...
	public NotificationPage validateNotificationTitle() {
		...
		try {
			...
			reportStep("The element "+notificationTitle+"is present on the visible portion", "PASS");

		} catch (Exception e) {

			reportStep("The element "+notificationTitle+"  is not present on the visible portion", "FAIL");
	...
	public NotificationPage validateAjioStoreRedirection() {
		...
		reportStep("About to validate Ajio Store - Redirection ", "INFO");

		validateTheElementPresence(ajioStore);
		return this;
	}
	...
	public NotificationPage validateNotificationTestStorePage() {
		...
		validateTheElementPresence(NotificationTestStore);
		return this;
	}
	...
	public NotificationPage validateTheAbsenceoflargeIcon() {
	...
	public NotificationPage validateTheAbsenceoflargeIcon(String deviceName) {
		...
		case "redmi":
			...
			reportStep("Not validated the Absence of large icon Instead validating the presence of default app icon", "INFO");
