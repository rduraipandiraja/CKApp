...
public class PaymentRequestPage extends WrapperMethods {
	...
	/*old*/
	/**************************************************************************************/
	//			@FindBy(how = How.XPATH, using = "//android.widget.Spinner[@content-desc='st_requestpayment_dropDown']/android.widget.TextView")
	//			MobileElement paymentMethodDropDown ;

	/**************************************************************************************/
	/*New*/
	/**************************************************************************************/
	@FindBy(how = How.XPATH, using = "(//android.view.ViewGroup)[20]")
	MobileElement paymentMethodDropDown ;
	...
	@FindBy(how = How.XPATH, using = "//android.widget.EditText[@text='Choose Charity']")
	...
	@FindBy(how = How.XPATH, using = "//android.widget.TextView[@text='Please enter valid Branch Name or 4 digit Branch code']")
	...
	MobileElement pleaseEnterTheIFSC;
	...
	@FindBy(how = How.XPATH, using = "//android.widget.TextView[contains(@text,'Please enter valid IFSC Code')]")
	MobileElement pleaseEnterValidIFSC;
	...
	@FindBy(how = How.XPATH, using = "//android.widget.TextView[contains(@text,'Cashback available for payment')]")
	MobileElement cashbackAvailableForPaymentText;

	@FindBy(how = How.XPATH, using = "//android.widget.TextView[contains(@text,'Rewards available for payment')]")
	...
	public PaymentRequestPage clickOnPaymentMethodDropDown() {
		...
		if(click(paymentMethodDropDown)) {
			...
			reportStep("Successfully clicked on the Payment dropdown to select the Payment Method to get the cashback ", "PASS");

		}else {

			reportStep("Failed to click onn the Payment dropdown to select the Payment method to get the cashback ", "FAIL");
		}
	...
	public PaymentRequestPage selectFlipKartGiftCardFromDropDown() {
		...
		if(click(selectFlipKartGiftCard)) {
			...
			reportStep("Failed to select the FlipKart from the payment method drop down  ", "FAIL");
		}
	...
	public PaymentRequestPage enterNEFT_IFSC(String NEFTAccountIFSC) {
		...
		if(enterText(bankIFSCCode, NEFTAccountIFSC)) {
			...
			reportStep("Successfully enter the  "+ NEFTAccountIFSC + " as  NEFT  IFSC Code " , "PASS");
		}else {

			reportStep("Failed to  enter the  "+ NEFTAccountIFSC + " as  NEFT IFSC Code " , "FAIL");
		}
	...
	public PaymentRequestPage enterFlipKartGiftCardEmailID(String flipKartEmailID) {
		...
		reportStep("About to enter the Email id as "+flipKartEmailID+"  for the Flipkart GiftCard Payment request   : ", "INFO");
	...
	public PaymentRequestPage enterPaytmWalletMobileNumber(String paytm_MobileNumber) {
		...
		reportStep("About to enter the Mobile number "+paytm_MobileNumber+"  to PaytmWalet payment request  : ", "INFO");
	...
	public PaymentRequestPage clickOnYescharityButton() {

		scrollFromDownToUpinApp();

		reportStep("About to click on Charity doation Yes button - reg  ", "INFO");

		if(click(charity_Yes)) {

			reportStep("Successfully clicked on the Charity Donation YES button   ", "PASS");
		}else {

			reportStep("Failed - Not able to click on Charity Donation YES button  ", "FAIL");
		}
	...
	public PaymentRequestPage clickOnCharityCloseButton() {

		reportStep("About to click On Charity Close button   ", "INFO");

		if(click(charityCloseButton)) {

			reportStep("Successfully clicked on the Charity close button  ", "PASS");
		}else {

			reportStep("Failed - Not able to click on Charity close button  ", "FAIL");
		}

		return this;
	}

	public PaymentRequestPage clickOnChooseCharity() {

		scrollFromDownToUpinApp();

		reportStep("About to click on Choose charity drop down link ", "INFO");

		if(click(chooseCharity)) {

			reportStep("Successfully clicked on the Choose Charity drop down ", "PASS");

		}else {

			reportStep("Not able to click on the Choose charity drop down link  ", "FAIL");
	...
	public PaymentRequestPage clickOnFirstCharityOption() {

		reportStep("About to click on First charity option from the choose charit drop down  ", "INFO");

		if(click(firstValidChrity)) {

			reportStep("Successfully clicked on the First Charity Option from the charity drop down ", "PASS");
	...
	public int enterCharityAmount() {

		scrollFromDownToUpinApp();

		reportStep("About to enter the Charity Amount to the field ", "INFO");

		int twoDigitValue = Utilities.randomNumbers_for_2digits();


		if(enterText(charityAmountField, Integer.toString(twoDigitValue))){

			reportStep("Successfully enter the Charity Amount as  "+ twoDigitValue, "PASS");

		}else {

			reportStep("Failed to enter the Two Digits charity value to the field : Two digit value is = "+ twoDigitValue, "FAIL");
	...
	public PaymentRequestPage enterCharityAmount(String charityAmount) {

		reportStep("About to enter the Charity Amount to the field : Amount as - "+ charityAmount , "INFO");

		if(enterText(charityAmountField,charityAmount)){

			reportStep("Successfully enter the Charity Amount as  "+ charityAmount, "PASS");

		}else {

			reportStep("Failed to enter the Two Digits charity value to the field : Two digit value is -  "+ charityAmount, "PASS");
	...
	public PaymentRequestPage enterCharityAmountAndvalidateCharityLeftOutAmount(){


		int charityEnteredAmount = enterCharityAmount();

		int leftOutAmout = 250 - charityEnteredAmount;

		String xpath = "//android.widget.TextView[contains(@text , 'Cashback left to redeem  ₹"+leftOutAmout+ ".00')]";
		...
		try {
			...
			reportStep("the given xpath "+ xpath + "is wrong ", "INFO");
		...
		reportStep("About to validate the charity leftOut amount  ", "INFO");
	...
	public PaymentRequestPage enterCharityAmountAndvalidateCharityLeftOutAmount(String availableBalance){

		String xpath = "//android.widget.TextView[contains(@text , 'Cashback left to redeem  ₹"+ availableBalance+ "')]";
	...
	public PaymentRequestPage validatePleaseSelectCharityErrorMessage() {

		reportStep("About to validate the Please select Charity Error message - ", "INFO");

		validateTheElementPresence(pleaseSelectTheCharityErroMessage);

		return this;

	}

	public PaymentRequestPage validateExceedCharityErrorMessage() {

		reportStep("About to validate the Exceed Charity amount  error message  - ", "INFO");

		validateTheElementPresence(charityExceedErroMessage);

		return this;

	}

	public PaymentRequestPage validatePleaseEnterSomeAmount() {

		reportStep("About to validate Please enter some amount - error message - ", "INFO");

		validateTheElementPresence(pleaseEnterSomeAmount);

		return this;

	}

	public PaymentRequestPage validateInvalidDonationAmountErrorMessage() {

		reportStep("About validate the Invalid donation amount error message  - - ", "INFO");

		validateTheElementPresence(invalidDonationAmount);
	...
	public PaymentRequestPage enterSpecialCharacterIntoAccountNumberAndValidateErrorMessage() {
		...
		enterNEFTBankName().
		enterNEFTBranchName().
		enterNEFTAccountNumber("#$%^&*!").enterNEFT_IFSC().clickOnGETPAIDForFailure().
		validateTheElementPresence(pleaseEnterTheBankAccountNum);
		return this;
	...
	public PaymentRequestPage enterAlphabetsIntoAccountNumberAndValidateErrorMessage() {
		...
		enterNEFTBankName().
		enterNEFTBranchName().
		enterNEFTAccountNumber("cashkaro").enterNEFT_IFSC().clickOnGETPAIDForFailure().
		validateTheElementPresence(pleaseEnterTheBankAccountNum);
		return this;

	}

	public PaymentRequestPage validatePleaseEnterIFSC() {

		reportStep("About validate the IFSC Error Message ", "INFO");
		...
		//Validate the Error Please Enter the IFSC
		validateTheElementPresence(pleaseEnterValidIFSC);
	...
	public PaymentRequestPage validatePleaseEnterBranchNameError() {

		reportStep("About to enter the number into bank branch name and validate  error message  ", "INFO");
