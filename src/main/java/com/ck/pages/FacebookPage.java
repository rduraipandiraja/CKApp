...
public class FacebookPage extends WrapperMethods {
	...
	public HomePage clickOnContinue() {
		...
		if(click_WaitFor25Sec(facebookIntermediatePageContinueButton)) {
	...
	public IntermediateRetailerPage clickOnContinueForIntermediatePageNavigation() {

		reportStep("About to click on the continue button for intermediate page navigation  ", "INFO");
