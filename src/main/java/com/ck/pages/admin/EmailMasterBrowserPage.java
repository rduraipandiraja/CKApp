...
public class EmailMasterBrowserPage extends WrapperMethods {
	...
	String siteTitleSelectXpath = "//select[@name='SITE_TITLE']";
	...
	public void selectHighPriorityWithNotificationTemplate() {
		...
		if(select_Dropdown(driver, notificationTemplateSelectionXpath, getTestData(13, "WithNotificationTemplate_HighPriority"))) {
			
			reportStep("Successfully selected the Notification Template ->"+ getTestData(13, "WithNotificationTemplate_HighPriority"), "PASS");
			
		}else {
			
			reportStep("Failed to select the Notification Template ->"+ getTestData(13, "WithNotificationTemplate_HighPriority"), "FAIL");
	...
	public void selectHighPriorityWithNotificationTemplate_WithoutRedirctURL_WithoutLargeIcon_WithoutBigImage() {
		...
		if(select_Dropdown(driver, notificationTemplateSelectionXpath, getTestData(13, "WithNotificationTemplate_HighPriority_WithoutRedirectionURLBigImageLLargeIcon"))) {

			reportStep("Successfully selected the Notification Template ->"+ getTestData(13, "WithNotificationTemplate_HighPriority_WithoutRedirectionURLBigImageLLargeIcon"), "PASS");

		}else {

			reportStep("Failed to select the Notification Template ->"+ getTestData(13, "WithNotificationTemplate_HighPriority_WithoutRedirectionURLBigImageLLargeIcon"), "FAIL");
	...
	public void selectHighPriorityWithNotificationTemplate_WithoutRedirctURL() {
		...
		if(select_Dropdown(driver, notificationTemplateSelectionXpath, getTestData(13, "WithNotificationTemplate_HighPriority_WithoutRedirectURL"))) {

			reportStep("Successfully selected the Notification Template ->"+ getTestData(13, "WithNotificationTemplate_HighPriority_WithoutRedirectURL"), "PASS");

		}else {

			reportStep("Failed to select the Notification Template ->"+ getTestData(13, "WithNotificationTemplate_HighPriority_WithoutRedirectURL"), "FAIL");
	...
	public void selectHighPriorityWithNotificationTemplate_RedirectionalURLAtDifferentPage() {
		...
		if(select_Dropdown(driver, notificationTemplateSelectionXpath, getTestData(13, "WithNotificationTemplate_HighPriority_RedirectionURLAtDifferentPage"))) {

			reportStep("Successfully selected the Notification Template ->"+ getTestData(13, "WithNotificationTemplate_HighPriority_RedirectionURLAtDifferentPage"), "PASS");

		}else {

			reportStep("Failed to select the Notification Template ->"+ getTestData(13, "WithNotificationTemplate_HighPriority_RedirectionURLAtDifferentPage"), "FAIL");
	...
	public void selectNormalPriorityWithNotificationTemplate() {
		...
		if(select_Dropdown(driver, notificationTemplateSelectionXpath, getTestData(13, "WithNotificationTemplate_NormalPriority"))) {

			reportStep("Successfully selected the Notification Template ->"+ getTestData(13, "WithNotificationTemplate_NormalPriority"), "PASS");

		}else {

			reportStep("Failed to select the Notification Template ->"+ getTestData(13, "WithNotificationTemplate_NormalPriority"), "FAIL");
	...
	public void selectSiteTitleAsUserName() {
		...
		reportStep("About to selecte the Site Title as :" +  getTestData(13, "DropDownValue_UserName"), "INFO");

		if(select_Dropdown(driver, siteTitleSelectXpath, getTestData(13, "DropDownValue_UserName"))) {

			reportStep("Successfully selected the Site Title value as : "+ getTestData(13, "DropDownValue_UserName"), "PASS");

		} else {

			reportStep("Failed to select the Site Title value as : "+ getTestData(13, "DropDownValue_UserName") , "FAIL");
		}
