...
public class AdminPartnerSettingsPage extends WrapperMethods {
	...
	@FindBy(how = How.XPATH, using = "//td[contains(.,'cashkaro.iamsavings.co.uk')]/parent::tr/td/a[1]") 
	MobileElement editPartnerDetails_Beta;

	@FindBy(how = How.XPATH, using = "//td[contains(.,'staging.cashkaro.com')]/parent::tr/td/a[1]") 
