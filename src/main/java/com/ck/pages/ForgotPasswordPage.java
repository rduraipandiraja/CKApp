...
public class ForgotPasswordPage extends WrapperMethods {
	...
	@FindBy(how = How.XPATH, using = "//android.widget.TextView[contains(@text,'Re-set your password')]")
	MobileElement resetYourPassword;
	@FindBy(how = How.XPATH, using = "//android.widget.TextView[contains(@text,'Tell us the Email ID you used to create your CashKaro A/c, and we will send you the Password Reset link in return')]")
	...
	@FindBy(how = How.XPATH, using = "//android.widget.TextView[contains(@text,'Remember your password? LOGIN')]")
	...
	@FindBy(how = How.XPATH, using = "//android.widget.TextView[contains(@text,'Sorry, there is no active account which match with this e-mail address: scgg@ggg.com')]")
	MobileElement sorryThreIs_ErrorText;
	...
	public ForgotPasswordPage validateAllobjects() {
		...
		validateTheElementPresence(resetYourPassword);
