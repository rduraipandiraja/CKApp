...
public class AccountSettingsPage extends WrapperMethods {
	...
	//Constructor call
	public AccountSettingsPage(AppiumDriver<MobileElement> driver, ExtentTest testInfo) {//doubt 1
	...
	@FindBy(how = How.XPATH, using = "//*[@text='The fullname field is required.']")
	...
	@FindBy(how = How.XPATH, using = "//android.widget.Spinner[@content-desc='st_PaymentSettings_setPaymentType']|(//android.view.ViewGroup)[31]")
	...
	@FindBy(how = How.XPATH, using = "//android.widget.TextView[contains(@text,'Please enter valid Branch Name or 4 digit Branch code')]")
	MobileElement branchFormatIsInvalid;
	...
	@FindBy(how = How.XPATH, using = "//android.widget.TextView[@text='NOTE: To change your email/mobile number please write to staging@cashkaro.com']")
	MobileElement personalDetailsToChangeYourEmailTextStaging;

	@FindBy(how = How.XPATH, using = "//android.widget.TextView[contains(@text,'NOTE: To change your email/mobile number please write to')]")
	MobileElement personalDetailsToChangeYourEmailTextBeta;
	...
	public AccountSettingsPage enterFullName(String value) {
		...
		try {
			enterText(personalDetailsFullName,value );
			reportStep("About to enter the User Full Name as : " + value , "PASS");
		} catch (Exception e) {
			reportStep("Exception is : "+ e.getMessage() , "INFO");
	...
	public AccountSettingsPage clickOnReceivWeeklyoffersNewsLetterRadioButton() {
		...
		try {
			click(receiveourWeeklyRadioButton);
	...
	public AccountSettingsPage clickOnReceiveEmailWhenIGetReferralRadioButton() {
		...
		try {
			click(receiveEmailWhenIGetReferralRadioButton);
	...
	public AccountSettingsPage clickOnChangePasswordTab() {
		...
		try {
			validateTheElementPresence(currentPasswordField);
	...
	public AccountSettingsPage clickOnPaymentSettings() {
		...
		try {
			click_WaitFor25Sec(paymentSettings);
	...
	public AccountSettingsPage validateNEFTPaymentSettings() {//doubt 2
		...
		try {
			WebDriverWait wait = new WebDriverWait(driver, 30);
			wait.until(ExpectedConditions.visibilityOf(accountNumberAfterSet));
			reportStep("The element "+accountNumberAfterSet+"  is successfully validated ", "PASS");
	...
	public AccountSettingsPage enterNEFTAccountHolderName() {
		...
		try {
			enterText(accountHolder, NEFTbankAccountHolder);
	...
	public AccountSettingsPage enterNEFTBankName() {
		...
		try {
			enterText(bankName, NEFTBankName);
	...
	public AccountSettingsPage enterNEFTBranchName() {
		...
		try {
			enterText(bankBranchName, NEFTBranchName);
	...
	public AccountSettingsPage enterNEFTAccountNumber() {
		...
		try {
			enterText(bankAccountNumber, NEFTAccountNumber);
	...
	public AccountSettingsPage enterNEFT_IFSC() {
		...
		try {
			enterText(bankIFSCCode, NEFTAccountIFSC);
	...
	public AccountSettingsPage enterPasswordToConfirm_NEFT() {//doubt3
		...
		try {
			enterText(enterPasswordToConfirm, testdata.get(3).get("Password"));
			reportStep("Successfully entered the Valid Password  as : " + testdata.get(3).get("Password"), "PASS");

		} catch (Exception e) {
			reportStep("Exception is : " + e.getMessage() , "INFO");
			reportStep("First time - Failed to enter the valid Password as : " + testdata.get(3).get("Password") , "INFO");
		}
		...
		try {
			...
			reportStep("Exception is : " + e.getMessage() , "INFO");
			reportStep("Second time - Failed to enter the valid Password as : " + testdata.get(3).get("Password") , "FAIL");
	...
	public AccountSettingsPage enterPasswordToConfirm_Amazon() {
		...
		try {
			enterText(enterPasswordToConfirm_Amazon, testdata.get(3).get("Password"));
			reportStep("Successfully entered the Valid Password  as : " + testdata.get(3).get("Password"), "PASS");
	...
	public AccountSettingsPage enterPasswordToConfirm_FlipKart() {
		...
		try {
			enterText(enterPasswordToConfirm_FlipKart, testdata.get(3).get("Password"));
			reportStep("Successfully entered the Valid Password  as : " + testdata.get(3).get("Password"), "PASS");
	...
	public AccountSettingsPage enterPasswordToConfirm_PaytmWallet() {
		...
		try {
			enterText(enterPasswordToConfirm_Paytm, testdata.get(3).get("Password"));
			reportStep("Successfully entered the Valid Password  as : " + testdata.get(3).get("Password"), "PASS");
	...
	public AccountSettingsPage enterAmazonGiftCardEmailID() {
		...
		try {
			enterTextInChrome(enterEmailForAmazonGC, getTestData(6, "AmazonGCEmail"));
	...
	public AccountSettingsPage enterAmazonGiftCardEmailID(String email) {
		...
		try {
			enterTextInChrome(enterEmailForAmazonGC, email);
			reportStep("Successfully enter the Amazon GiftCard ", "PASS");
	...
	public AccountSettingsPage enterFlipKartGiftCardEmailID() {
		...
		try {
			enterTextInChrome(enterEmailForFlipKartGC, getTestData(6, "AmazonGCEmail"));
			reportStep("Successfully enter the FlipKart GiftCard ", "PASS");
		} catch (Exception e) {
			reportStep("Ecxeption is : " + e.getMessage(), "INFO");
	...
	public AccountSettingsPage enterFlipKartGiftCardEmailID(String email) {
		...
		try {
			enterTextInChrome(enterEmailForFlipKartGC, email);
			reportStep("Successfully enter the FlipKart GiftCard ", "PASS");
	...
	public AccountSettingsPage enterPaytmWalletMobileNumber(String mobileNumber) {
		...
		try {
			enterTextInChrome(paytmMobileNumberField, mobileNumber);
	...
	public AccountSettingsPage enterSpecialCharacterIntoBankBranchNameAndValidateErrorMessage() {
		...
		enterPasswordToConfirm_NEFT().
		clickOnSaveChangesButton();
		validateTheElementPresence(branchFormatIsInvalid);
	...
	public AccountSettingsPage validateNoteInAccountSetting() {// doubt 4

		reportStep("About to validate the Note in Account Settigs Page", "PASS");

		try {
			if(PropertyFile.ENVIRONMENT.equals("Staging")){
				validateTheElementPresence(personalDetailsToChangeYourEmailTextStaging);
			}else {
				validateTheElementPresence(personalDetailsToChangeYourEmailTextBeta);
			}
