...
public class Base  {
	...
	public void beforeSuite() {
		...
		adminPassword = testdata.get(8).get("AdminPassword");
		System.out.println("About to set the Password as " + adminPassword );

		try {
			OkHttpClient client = new OkHttpClient();
			Request request = new Request.Builder()
					.url(GetCodeSetup.CKBASEURL + "getcode.php?page=update_admin_user_password&uname=dev&pwd="+adminPassword)
					.get()
	...
	public void setup() {
		...
		screenshotOnTestFail = true;
		screenshotOnTestPass = true;
	...
	public void beforeMethodDoThis(String udid,String port,Integer systemPort, String automationName,String deviceName,String androidVersion, String APILevel,Method method) throws Exception  {
		...
		//App info
		dc.setCapability("appPackage", "com.cashkaro");
		dc.setCapability("appActivity", "com.cashkaro.MainActivity");
		...
		testInfo.log(Status.INFO, "####  DESIRED CAPABILITY IS SET AS ####"
				...
				+ "  appPackage : com.cashkaro "
				+ "  appActivity : com.cashkaro.MainActivity"
